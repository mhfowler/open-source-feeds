...
if __name__ == '__main__':
    # input_path = os.path.join(DATA_DIR, 'friends/maximusfowler.txt')
    # get_friends_posts(driver=driver, input_path=input_path)
    # get_friends_of_friends(username='maximusfowler')
    # get_posts_from_all_users()

    driver = webdriver.Firefox()
    fb_login(driver)
    get_friends(driver=driver, user='maxhfowler')
    # print(search('banana'))
    # fb_search(driver=driver, user='evan.sumortin')
